    ...
    <template v-else-if="view === 'chat' && inbox.activeConversation">
      ...
      <div ref="messagesEl" class="flex-1 overflow-y-auto space-y-1 p-3">
        ...
        <template v-else>
          ...
          >
            <div
              class="max-w-[78%] rounded-2xl px-3.5 py-2.5 text-sm"
      ...
      <div class="flex items-end gap-2 border-t border-slate-100 px-3 py-2.5 dark:border-zinc-800">
        <button class="shrink-0 p-1.5 text-slate-400 hover:text-slate-600 dark:hover:text-zinc-300" @click="showEmojiPicker = !showEmojiPicker">
