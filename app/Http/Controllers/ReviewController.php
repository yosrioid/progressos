...
class ReviewController extends Controller
{
    public function daily(Request $request)
    {
        ...
        return Inertia::render('Reviews/Daily', [
            ...
            'tasks' => $request->user()->tasks()->with('project')->where(fn ($q) => $q->whereDate('due_date', $date)->orWhere(fn ($w) => $w->whereNull('due_date')->whereIn('status', ['todo', 'in_progress', 'blocked'])))->get(),
